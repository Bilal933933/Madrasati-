  ...
  return (
    <ExploreShell>
      ...
      <div className="mx-auto mt-6 max-w-3xl">
        ...
        <ScrollReveal delay={100} className="mt-3 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
        ...
        <ScrollReveal delay={250} className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
