...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "نعم، إنشاء الحساب مجاني تمامًا — لحظة «أريد أن أكمل» هي وحدها التي تستدعيه، ولا يكلف شيئًا.",
  },
  {
    question: "كيف يتم التقييم؟",
    answer:
      "تقييم قبلي في البداية لتحديد نقطة انطلاقك، ثم سؤال قصير بعد كل فقرة للتأكد من فهمك، وتقييم نهائي في الختام لقياس إتقانك.",
  },
];
