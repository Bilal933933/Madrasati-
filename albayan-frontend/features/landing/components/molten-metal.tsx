...
/**
 * خلفية "Molten Metal" — shader WebGL تظهر في الصفحة العامة كخلفية متحركة.
 * موضّبة بألوان الثيم، مع تحسينات أداء جاهزة (إيقاف خارج الشاشة/التبويب، DPR≤2، تفاعل الماوس).
 */
...
// استخدام WeakMap للاحتفاظ بالسياق بين الـ useEffect للتهيئة وتحديث الخصائص.
...
export function MoltenMetal({
  ...
  return <div ref={containerRef} className={`molten-metal-container ${className}`.trim()} aria-hidden />;
}